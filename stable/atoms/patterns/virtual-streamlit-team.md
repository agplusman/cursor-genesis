...
| :--- | :--- |
| **TPM** (Product) | `prompts-library/templates/capabilities/01_insight/technical-pm.md` |
| **SPEC** (Systems) | `prompts-library/templates/capabilities/02_architecture/systems-designer.md` |
| **MAP** (Architect) | `prompts-library/templates/capabilities/02_architecture/project-mapper.md` |
| **DEV** (Frontend) | `prompts-library/templates/capabilities/03_engineering/streamlit-expert.md` |
| **FIX** (Maintenance)| `prompts-library/templates/capabilities/03_engineering/code-maintainer.md` |
| **QA** (Testing) | `prompts-library/templates/capabilities/04_quality/rubric-specialist.md` |
| **OPS** (Delivery) | `prompts-library/templates/capabilities/03_engineering/python-distributor.md` |
| **ARCH** (Prometheus)| `prompts-library/templates/capabilities/02_architecture/prometheus-prompt-engineer.md` |
